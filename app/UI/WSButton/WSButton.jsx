...
export default function WSButton({ ...props }) {
  return (
    <Button className="relative bg-[#0a49eb] hover:bg-[#0f3bbe] ml-auto h-10  w-40 max-lg:w-50  group transition-all duration-300 flex items-center gap-2 lg:text-[12px] cursor-pointer ">
      {props.value}
